...
1. **Setup**: Run the OS-appropriate prerequisite script from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS list:
   - macOS/Linux/WSL/Git Bash: `.specify/scripts/bash/check-prerequisites.sh --json`
