...
1. Run the OS-appropriate prerequisite script from repo root **once** and parse minimal JSON payload fields:
   - macOS/Linux/WSL/Git Bash: `.specify/scripts/bash/check-prerequisites.sh --json --paths-only`
